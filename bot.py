...
SLAP_LIST = [
    ...
    "💬 {a}, {b}’yi emoji yağmuruna tuttu 💬",
    "🧼 {a}, {b}’ye köpükle dokundu 🫧",
    "🧸 {a}, {b}’nin omzuna oyuncak çarptı 🧸",
    "📺 {a}, {b}’ye uzaktan kumandayla saldırdı 📺",
    "🐔 {a}, {b}’nin üstüne tavuk kostümü fırlattı 🐔",
    "🪑 {a}, {b}’ye sandalye savurdu 🪑",
    "🩴 {a}, {b}’ye görünmez terlik attı 🩴",
    "🍕 {a}, {b}’yi pizza kutusuyla yakaladı 🍕",
    "🥛 {a}, {b}’ye 3D yoğurt yağmuru başlattı 🥛",
    "🥔 {a}, {b}’ye glitch patates fırlattı 🥔",
    "💥 {a}, {b}’nin üstüne dev emoji düştü 💥",
    "😭 {a}, {b}’yi internetten silmeye çalıştı ama başaramadı 😭",
    "🍌 {a}, {b}’ye muzla kaydırma yaptı 🍌",
    "💥 {a}, {b}’ye +999 hasar verdi (ama sadece gıdıklama etkisi 😄)",
    "💻 {a}, {b}’yi 404 error ile çarptı 💻",
    "📶 {a}, {b}’ye lag spike tokadı attı 📶",
    "🟣 {a}, {b}’yi pixel patlamasına soktu 🟣",
    "🎮 {a}, {b}’ye “rage quit” enerjisi gönderdi 🎮",
    "🎈 {a}, {b}’ye balon fırlattı 🎈",
    "🛏️ {a}, {b} ile yastık savaşı başlattı 🛏️",
    "🎂 {a}, {b}’ye kek attı 🎂",
    "😊 {a}, {b}’ye gülücük saldırısı yaptı 😊",
    "🎉 {a}, {b}’yi yanlışlıkla konfetiye boğdu 🎉",
    "🥔 {a}, {b}'ye patates fırlattı 😂",
    "🩴 {a}, {b}'ye terlik roketi fırlattı 😂",
    "🍕 {a}, {b}'yi pizza bombardımanına tuttu",
    "📺 {a}, {b}'ye televizyon dropkick yaptı 💀",
    "🐟 {a}, {b}'ye balıkla combo yaptı",
    "🪑 {a}, {b}'ye sandalye ulti attı",
    "🍌 {a}, {b} kaygan muz tuzağı kurdu",
    "💥 {a}, {b} glitch evrenine itti",
    "🧃 {a}, {b}'ye soğuk meyve suyu saldırısı yaptı",
    "🎯 {a}, {b}'yi hedef aldı ve ıskaladı 😭",
    "🧠 {a}, {b}'nin beyin RAM’ini dondurdu",
    "📦 {a}, {b}'ye kutu spam yaptı",
    "🪄 {a}, {b}'yi yanlışlıkla NPC’ye çevirdi"
